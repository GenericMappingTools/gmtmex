 ...
 * Call any of the GMT modules while passing data in and out of GMT.
 *
 * First argument to the gmt function is the module name
 * Second argument is the option string
...
void mexFunction (int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
	...
	/* 9. Destroy linked option list and session */
